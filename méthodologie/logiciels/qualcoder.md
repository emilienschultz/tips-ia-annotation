...
Cela permet de circuler dans le corpus de manière de manière itérative (découvrabilité des thèmes).

Cela permet de produire en sortie les thèmes identifiés (regroupés par thèmes, par entretiens), avoir des sorties graphiques de leur distribution dans le corpus.

C'est une version alternative, libre et gratuite aux logiciels connus.
...
Possibilité de lancer aussi directement des sources
